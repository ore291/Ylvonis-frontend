...
function SongCard(props:SongCardProps) {
  return (
    <div className='bg-transparent relative h-[250px] w-full cursor-pointer'>
  
      <div className='card-img relative h-[200px] w-full'>
        ...
        <Image src={`/${props.img}`} alt='song image' fill className=' shadow-md object-cover rounded-md' />
      </div>
