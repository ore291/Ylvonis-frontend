...
import { useGetFollowedArtistsQuery } from '@/store/api/artist'
import React from 'react'
import { BsListUl } from 'react-icons/bs'

function FollowedArtists() {
  const { data: artists, isFetching, isLoading } = useGetFollowedArtistsQuery(
    null,
    {
    ...
    <main>
      ...
      <section className=" mt-2 mb-10 p-2">
        {isLoading ? (
          ...
          <p className="text-xl font-medium text-center">No Followed Artist Found</p>
        )}
      </section>
    </main>
  )
